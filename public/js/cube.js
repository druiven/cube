...
// Created by Simon Speich
    ...
    let Q = new Array();
    let MTrans = new Array();  // transformation matrix
    let MQube = new Array();  // position information of qube
    let I = new Array();      // entity matrix
    let Origin = new Object();
    let Testing = new Object();
    let LoopTimer;
    ...
    function CalcNormal(V0, V1, V2) {
        let A = new Array();   let B = new Array();
        for (let i = 0; i < 3; i++) {
            A[i] = V0[i] - V1[i];
            B[i] = V2[i] - V1[i];
        }
