class Canvas {
    constructor(id, parentId = 'c-wrapper', width = 100, height = 100, cX = 0, cY = 0, alpha = 1, zIndex = '0') {
        this.id = id;
        this.listId = null;
...
//
                ...
                r = triangles[i].rgbd[0] * delta;
                g = triangles[i].rgbd[1] * delta;
                b = triangles[i].rgbd[2] * delta;
