...
function update() {
    ...
    Cubes.rotatedPosition=Cubes.position;
    //Cubes.rotatedPosition[0]=Cubes.position[0]+worldMatrix[3];
    //Cubes.rotatedPosition[1]=Cubes.position[1]+worldMatrix[7];
    //Cubes.rotatedPosition[2]=Cubes.position[2]+worldMatrix[11];
    //Cubes.groupMatrix=MMulti([...Cubes.groupMatrix],worldMatrix);
    console.table(Cubes.groupMatrix);
